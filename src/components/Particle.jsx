  ...
  const options = useMemo(() => {
    ...
    return {
      ...
      fullScreen: {
        ...
        zIndex: 99, // this is the z-index value used when the fullScreen is enabled, it's 0 by default
      },
      interactivity: {
        events: {
          onClick: {
      ...
      particles: {
        ...
        opacity: {
          value: { min: 0.0, max: 0.3 }, // using a different opacity, to have some semitransparent effects
        },
        size: {
